...
func GetOAuthTokenWithClientCredentials(scope string, opts ...OAuthOption) (*oauth2.Token, error) {
	return globalClient.GetOAuthTokenWithClientCredentials(scope, opts...)
}
